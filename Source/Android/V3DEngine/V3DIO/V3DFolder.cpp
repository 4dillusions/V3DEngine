...
namespace V3D::V3DEngine::V3DIO
{
	...
	{
		auto* const dir = AAssetManager_openDir(static_cast<android_app*>(GetEnvironment()->GetApp())->activity->assetManager,
			V3DString(GetEnvironment()->GetAssetPath(path)).ToChar());
