...
namespace V3D::V3DEngineTests::V3DEngine::V3DMathematics
{
	void V3DQuaternionTests::OperatorsTest()
	{
		...
		V3DTest::AssertOk(Quat.x == 30.0f, V3DFILE_INFO);
		V3DTest::AssertOk(Quat.y == 40.0f, V3DFILE_INFO);
		V3DTest::AssertOk(Quat.z == 50.0f, V3DFILE_INFO);
		V3DTest::AssertOk(Quat.w == 20.0f, V3DFILE_INFO);
	...
	{
		V3DTest::AssertOk(V3DQuaternion(0.1f, 0.2f, 0.2f, 0.4f).Length() == 0.5f, V3DFILE_INFO);
		V3DTest::AssertOk(V3DQuaternion(1, 2, 3, 4).DotProduct(V3DQuaternion(6, 7, 8, 10)) == 84.0f, V3DFILE_INFO);

		V3DTest::AssertOk(V3DQuaternion(1, 1, 1, 1).RotationAngle() == 60.0f, V3DFILE_INFO);
		V3DTest::AssertOk(V3DQuaternion(1, 0, 0, 0).RotationAngle() == 180.0f, V3DFILE_INFO);
		V3DTest::AssertOk(V3DQuaternion(0.7071f, 0, 0.7071f, 0).RotationAngle() == 90.0f, V3DFILE_INFO);
		...
		V3DTest::AssertOk(V3DMath::IsEqual(V3DQuaternion(1, 2, 3, 4).Normalise(), V3DQuaternion(1, 2, 3, 4).Length()), V3DFILE_INFO);
