...
namespace V3D::V3DEngineTests::V3DEngine::V3DCore
{
	...
	void V3DComponentTests::GameCompositeComponentPoolTest()
	{
		...
		const auto sprite1 = gameLayerPool->Add();
