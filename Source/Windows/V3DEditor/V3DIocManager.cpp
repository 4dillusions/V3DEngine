...
#include "V3DEdView/V3DPropertyTreeBuilder.h"
#include "V3DEdData/V3DEdTextFileManager.h"
...
using namespace V3DEdData;
using namespace V3DEdService;
using namespace V3DEdController;

namespace V3D::V3DEngine::V3DCore
{
	//Warning!! Dont inject trasient obj for singleton!
	void V3DIocManager::Init()
	{
		...
		V3DIoc<V3DPropertyTreeBuilder>::RegisterAndCreateSingleton<V3DPropertyTreeBuilder>();
		V3DIoc<V3DEdITextFileManager>::RegisterAndCreateSingleton<V3DEdTextFileManager>();

		V3DIoc<V3DEdMainView>::RegisterAndCreateSingleton<V3DEdMainView>(V3DFunc<V3DEdMainView*>([] { return V3DMemory::New<V3DEdMainView>(V3DFILE_INFO, V3DIoc<V3DEdModelLocator>::GetSingleton(), V3DIoc<V3DEdViewBindings>::GetSingleton(), V3DIoc<V3DPropertyTreeBuilder>::GetSingleton()); }));
		V3DIoc<V3DEdSettingsView>::RegisterTransient<V3DEdSettingsView>(V3DFunc<V3DEdSettingsView*>([] { return V3DMemory::New<V3DEdSettingsView>(V3DFILE_INFO, V3DIoc<V3DEdModelLocator>::GetSingleton()->CreateOrGetSettingsModel(), V3DIoc<V3DEdViewBindings>::GetSingleton(), V3DIoc<V3DPropertyTreeBuilder>::GetSingleton()); }));

		V3DIoc<V3DEdIViewManager>::RegisterAndCreateSingleton<V3DEdViewManager>(V3DFunc<V3DEdIViewManager*>([] { return V3DMemory::New<V3DEdViewManager>(V3DFILE_INFO, V3DIoc<V3DEdModelLocator>::GetSingleton(), V3DIoc<V3DEdControllerLocator>::GetSingleton(), V3DIoc<V3DEdMainView>::GetSingleton(), V3DIoc<V3DPropertyTreeBuilder>::GetSingleton()); }));

		V3DIoc<V3DEdMainService>::RegisterAndCreateSingleton<V3DEdMainService>(V3DFunc<V3DEdMainService*>([] { return V3DMemory::New<V3DEdMainService>(V3DFILE_INFO, V3DIoc<V3DEdIViewManager>::GetSingleton(), V3DIoc<V3DEdModelLocator>::GetSingleton(), V3DIoc<V3DLogger>::GetSingleton()); }));
		...
		V3DIoc<V3DEdSettingsService>::RegisterAndCreateSingleton<V3DEdSettingsService>(V3DFunc<V3DEdSettingsService*>([] { return V3DMemory::New<V3DEdSettingsService>(V3DFILE_INFO, V3DIoc<V3DEdIViewManager>::GetSingleton(), V3DIoc<V3DEdITextFileManager>::GetSingleton(), V3DIoc<V3DEdModelLocator>::GetSingleton()); }));
